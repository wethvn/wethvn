...
description: Boneh-Lynn-Shacham - chữ ký BLS dùng trong Consensus Layer
---
...
![Diagram showing key pair generation and verification for BLS](img/bls-alice.png)
...
![Diagram showing how we will depict the various components in the diagrams below.](img/bls-key.svg)
...
![Diagram of the generation of the public key.](img/bls-setup.svg)
...
![Diagram of signing a message.](img/bls-signing.svg)
...
![Diagram of verifying a signature.](img/bls-verifying.svg)
