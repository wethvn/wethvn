---
title: EL Client Architecture
description: Kiến trúc của Execution Layer client
---
...
![Payload Validation Routine](img/payload-validation-routine.png)
...
| $$H_{nonce} = 0x0000000000000000 $$                                                  | validate_header-> [ensure](https://github.com/ethereum/execution-specs/blob/9fc7925c80ff2f3949e1cc340a4a0d36fcd4161c/src/ethereum/cancun/fork.py#
