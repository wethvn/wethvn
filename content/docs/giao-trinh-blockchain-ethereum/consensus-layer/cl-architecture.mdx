---
title: CL Client Architecture
description: Kiến trúc của Consensus Layer client
---
...
![Diagram for Block Tree](img/blocktree.svg)
...
![Diagram for Reorg-0](img/reorg-0.svg)
...
![Diagram for Reorg-1](img/reorg-1.svg)
...
![Diagram for Network](img/network.png)
