---
title: CL Networking
description: Giao thức mạng của Consensus Layer
---
...
![libp2p_protocols](img/libp2p-protocols.png)
...
![flowchart of setting up a connection](img/libp2p-connection.png)
...
![gossipsub_optimization](img/gossipsub_optimization.png)
