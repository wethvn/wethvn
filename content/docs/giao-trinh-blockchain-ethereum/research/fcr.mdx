---
title: FCR
description: Fast Confirmation Rule - quy tắc xác nhận nhanh trong Ethereum
---
...
> details
> Why FCR Exists if we will have SSF anyway
>
...
- [Fast Confirmation Rule - Roberto Saltini (2025 video)](https://www.youtube.com/watch?v=dZU-Ch22MKY&list=PLCGgAwcxXAWyHcMm0X57jVuHtJ6e8gwIP&index=25)
...
- [Lighthouse PoC EPF work by Harsh Pratap Singh](https://hackmd.io/6H_e-WqaQFyBENsifLiH6g)
