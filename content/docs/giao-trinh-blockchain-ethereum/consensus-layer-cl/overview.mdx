---
title: CL Overview
description: Tổng quan về Consensus Layer của Ethereum
---
...
_Example of one checkpoint getting justified (Slot 64) and finalizing RANDAO.png prior checkpoint (Slot 32)._
